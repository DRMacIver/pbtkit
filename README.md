...
[Pbtkit](https://github.com/DRMacIver/pbtkit) was a minimalist implementation of the core idea of the original [Hypothesis](https://github.com/HypothesisWorks/hypothesis) implementation.[^1]
...
[^1]: If you see parts that are still named "pbtkit" or similar, that's why.
